#include "manpudialog.h"
#include "ui_manpudialog.h"
#include "mainwindow.h"

ManPuDialog::ManPuDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ManPuDialog)
{
    ui->setupUi(this);
    ui->setupUi(this);
...
ManPuDialog::~ManPuDialog()
{
    delete ui;
}

void ManPuDialog::GetMainWindow(MainWindow *w)
{
    mainwindow=w;    //获取主窗口指针
}

void ManPuDialog::bt_cancel_clicked()
{
    this->close();
}

void ManPuDialog::paintEvent(QPaintEvent *)
{
...
bool ManPuDialog::eventFilter(QObject *obj, QEvent *event)
{
