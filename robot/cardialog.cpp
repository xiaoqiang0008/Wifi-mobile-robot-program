...
CarDialog::CarDialog(QDialog *parent) :
    QDialog(parent),
    ui(new Ui::CarDialog)
{
    ui->setupUi(this);
...
void CarDialog::GetMainWindow(MainWindow *w)
{
    mainwindow=w;    //获取主窗口指针
}

void CarDialog::bt_cancel_clicked()
{
    this->close();
}
...
bool CarDialog::eventFilter(QObject *obj, QEvent *event)
{
